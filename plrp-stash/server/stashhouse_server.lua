...
RegisterNetEvent('plrp-stash:fetchInitialState')
AddEventHandler('plrp-stash:fetchInitialState', function()
	local source = source
	TriggerClientEvent('plrp-stash:setInitialState', source, Config.Stash)
end)
